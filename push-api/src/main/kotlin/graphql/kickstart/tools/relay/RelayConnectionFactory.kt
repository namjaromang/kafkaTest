...
class RelayConnectionFactory : TypeDefinitionFactory {
    ...
    override fun create(existing: List<Definition<*>>): List<Definition<*>> {
        ...
        if (!definitionsByName.containsKey("CustomPageInfo")) {
    ...
    private fun createConnectionDefinition(type: String): ObjectTypeDefinition =
            ObjectTypeDefinition.newObjectTypeDefinition()
                    ...
                    .fieldDefinition(FieldDefinition("pageInfo", TypeName("CustomPageInfo")))
                    .build()
    ...
    private fun createPageInfo(): ObjectTypeDefinition =
            ObjectTypeDefinition.newObjectTypeDefinition()
                    ...
                    .fieldDefinition(FieldDefinition("startCursor", NonNullType(TypeName("String"))))
                    .fieldDefinition(FieldDefinition("endCursor", NonNullType(TypeName("String"))))
                    .fieldDefinition(FieldDefinition("totalPagesCount", NonNullType(TypeName("Long"))))
                    .fieldDefinition(FieldDefinition("totalElementsCount", NonNullType(TypeName("Long"))))
                    .build()
